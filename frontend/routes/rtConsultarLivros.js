...
var livrosConsultarApp = require("../apps/livros/controller/ctlConsultarLivros");
...
router.get('/ConsultarLivros', authenticationMiddleware, livrosConsultarApp.consultarLivros); 
